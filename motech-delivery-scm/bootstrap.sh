...
# to setup vm : wget https://github.com/motech/motech-delivery/raw/master/motech-delivery-scm/bootstrap.sh && sh ./bootstrap.sh url_for_epel_rpm

if [ "$#" -lt 1 ]; then
  echo "MoTeCH: Bootstrap Machine:"
  echo "Usage: sh ./bootstrap.sh url_for_epel_rpm\n"
  echo "URLs:"
